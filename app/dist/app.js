...
const studios = [
    ...
    { id: '3d', name: '3D Lighting Studio', short: '3D', subtitle: 'Modelos, anatomia y luces 3D', src: './legacy/3d-lighting/index.html?embed=1&phase=5', accent: 'indigo', icon: h(Icon, { name: 'three' }), hotkey: 'Alt+5' },
