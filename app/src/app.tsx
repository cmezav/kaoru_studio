...
type StudioId = 'silhouette' | 'text' | 'image' | 'light' | '3d' | 'combiner' | 'gallery';
...
const studios:Studio[]=[
  ...
  {id:'combiner',name:'Image Combiner Studio',short:'Combiner',subtitle:'Lienzos, capas y composiciones de imagen',src:'./legacy/image-combiner/index.html?embed=1&phase=6&rev=1',accent:'coral',icon:h(Icon,{name:'combine'}),hotkey:'Alt+6'},
...
class App extends React.Component<any,{active:StudioId;theme:Theme;frameSrc:string}>{
  ...
  onKey(e:KeyboardEvent){
    ...
    const map:any={'1':'silhouette','2':'text','3':'image','4':'light','5':'3d','6':'combiner','7':'gallery'};
