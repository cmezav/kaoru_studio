(function(){'use strict';
  ...
  function defaults(){return{
    ...
    lens:{enabled:false,radius:12,lightness:50,shape:'circle',opacity:.65,size:18,threshold:72,softness:35,rotation:0,density:50,saturation:100,focusX:.5,focusY:.5,focusRadius:.24,transition:.18},
  ...
  function merge(source){const base=defaults();source=source&&typeof source==='object'?source:{};return{
    ...base,...clone(source),
    adjustments:{...base.adjustments,...(source.adjustments||{})},sharpness:{...base.sharpness,...(source.sharpness||{})},filters:{...base.filters,...(source.filters||{})},grain:{...base.grain,...(source.grain||{})},lens:{...base.lens,...(source.lens||{})},transform:{...base.transform,...(source.transform||{})},crop:{...base.crop,...(source.crop||{})}
  }}
