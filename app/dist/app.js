...
const studios = [
    ...
    { id: 'light', name: 'Light Lab', short: 'Light Lab', subtitle: 'Paletas, luces, pieles y materiales', src: './legacy/light-lab/index.html?embed=1&phase=6', accent: 'teal', icon: h(Icon, { name: 'light' }), hotkey: 'Alt+4' },
