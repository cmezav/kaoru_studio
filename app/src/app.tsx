...
const studios:Studio[]=[
  ...
  {id:'combiner',name:'Image Combiner Studio',short:'Combiner',subtitle:'Lienzos, capas y composiciones de imagen',src:'./legacy/image-combiner/index.html?embed=1&phase=4',accent:'coral',icon:h(Icon,{name:'combine'}),hotkey:'Alt+6'},
